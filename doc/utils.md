...
|  [domGetSize(el)](./utils.domgetsize.md) | 获取dom尺寸 |
...
|  [getToday(format)](./utils.gettoday.md) | 获取今天的日期 |
|  [hexToRgb(hex)](./utils.hextorgb.md) | hux转rgb |
...
|  [strComplement(n, len, char)](./utils.strcomplement.md) | 根据需要的长度，在字符前串补足指定字符（比如0） |
...
|  [strRandom(count, digit)](./utils.strrandom.md) | 获取指定长度随机字符 |
...
|  --- | --- |
|  [getStorage](./utils.getstorage.md) | 从localStorage读取 |
|  [removeStorage](./utils.removestorage.md) | 从localStorage移除 |
|  [setStorage](./utils.setstorage.md) | 保存至localStorage |
